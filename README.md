...
Pushing (or merging) to the *master* branch updates the project present at: 
 https://n7-ariannaweb-graphql.net7.now.sh whilst pushing (or merging) to the *develop* branch updates the one present at: https://n7-ariannaweb-graphql-git-develop.net7.now.sh/
